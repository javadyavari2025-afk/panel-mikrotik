...
export function TrafficChart() {
  ...
  return (
    <Card className='border-border/60 col-span-1 flex flex-col pt-0 lg:col-span-5'>
      <CardHeader className='border-border/60 flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row'>
        <div className='grid flex-1 gap-1'>
          <CardTitle>
            <h2 className='text-foreground mb-4 flex items-center gap-2 text-lg font-semibold'>
              <span className='h-5 w-1 rounded-full bg-gradient-to-b from-violet-500 via-emerald-500 to-amber-500' />
              Daily Traffic Usage
            </h2>
          </CardTitle>
        </div>
